  ...
  return (
    <section className='max-w-7x1 mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] tex-[16px] max-w [500px]'>Browse throgh a collection of imaginative and visually stunning images generates by DALL-E AI</p>
        ...
        <div className='mt-10'>
          {loading ? (
            ...
            <>
              ...
              <div className='grid lg:grid-cols-4 sm:grid-cols-m xd:grid-cols-2 grid-cols-1 gap-3'>
                {searchText ? (
                  <RenderCards
                    data={[]}
